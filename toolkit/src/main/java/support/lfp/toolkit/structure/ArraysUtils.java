 ...
 *      join()              :将一个集合数据拼接成字符串
 *      asList()            :将数组转换为列表
 *      binarySearch()      :在数组中使用二分查找某个元素的位置
 *      fill()              :初始化数组中的所有元素
 *      hashCode()          :获得数组的hash值
 *      deepHashCode()      :获得数组的hash值-更精细
 *      equals()            :判断两个数组的值是否完全相同
 *      deepEquals()        :判断两个多维数组的值是否完全相同
 *      toString()          :显示数组的内容
 *      deepToStringImpl()  :显示多维数组的内容
...
public class ArraysUtils {
    ...
    public static <T> List<T> asList(T... array) {
        return new ArraysUtils.ArrayList(array);
    }
    ...
    private static int deepHashCodeElement(Object element) {
        if (element == null) {
            ...
            if (cl == null) {
                ...
                return cl.equals(Double.TYPE) ? hashCode((double[]) element) : hashCode((short[]) element);
            }
        }
    }
    ...
    private static boolean deepEqualsElements(Object e1, Object e2) {
        if (e1 == e2) {
            ...
            } else if (cl1.equals(Integer.TYPE)) {
                return equals((int[]) e1, (int[]) e2);
            } else if (cl1.equals(Character.TYPE)) {
                return equals((char[]) e1, (char[]) e2);
            } else if (cl1.equals(Boolean.TYPE)) {
                return equals((boolean[]) e1, (boolean[]) e2);
            } else if (cl1.equals(Byte.TYPE)) {
                return equals((byte[]) e1, (byte[]) e2);
            } else if (cl1.equals(Long.TYPE)) {
                return equals((long[]) e1, (long[]) e2);
            } else if (cl1.equals(Float.TYPE)) {
                return equals((float[]) e1, (float[]) e2);
            } else {
                return cl1.equals(Double.TYPE) ? equals((double[]) e1, (double[]) e2) : equals((short[]) e1, (short[]) e2);
            }
        } else {
            return false;
        }
    ...
    public static <T> T[] copyOf(T[] original, int newLength) {
        if (original == null) {
            ...
            return (T[]) copyOfRange((Object[]) original, 0, newLength);
        }
    }
